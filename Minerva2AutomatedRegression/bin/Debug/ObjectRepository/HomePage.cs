...
namespace Minerva2AutomatedRegression
{
    class HomePage
    {
        ...
        private HtmlHyperlink rehabphaseCellLink;
        public HtmlHyperlink RehabPhaseCellLink
        {
            get
            {
                rehabphaseCellLink = new HtmlHyperlink(localbw);
                rehabphaseCellLink.SearchProperties[HtmlHyperlink.PropertyNames.Class] = "searchGridCol";
                rehabphaseCellLink.SearchProperties[HtmlHyperlink.PropertyNames.InnerText] = "Rehab";
                return rehabphaseCellLink;
            }
        }

        private HtmlHyperlink relocationphaseCellLink;
        public HtmlHyperlink RelocationPhaseCellLink
        {
            get
            {
                relocationphaseCellLink = new HtmlHyperlink(localbw);
                relocationphaseCellLink.SearchProperties[HtmlHyperlink.PropertyNames.Class] = "searchGridCol";
                relocationphaseCellLink.SearchProperties[HtmlHyperlink.PropertyNames.InnerText] = "Relocation";
                return relocationphaseCellLink;
            }
        }

        private HtmlCell pidTableCell;
        public HtmlCell PIDTableCell
        {
            get
            {
               
                pidTableCell = new HtmlCell(localbw);
                pidTableCell.SearchProperties[HtmlCell.PropertyNames.Class] = "text-center";
                //pidTableCell.SearchProperties[HtmlCell.PropertyNames.TagInstance] = "2";
                pidTableCell.SearchProperties[HtmlCell.PropertyNames.ColumnIndex] = "1";
                pidTableCell.SearchProperties[HtmlCell.PropertyNames.TagName] = "TD";
                pidTableCell.SearchProperties[HtmlCell.PropertyNames.ClassName] = "HtmlTableCell";
                return pidTableCell;
            }
        }

        private HtmlHyperlink addressHyperLink;
        public HtmlHyperlink AddressHyperLink
        {
            get
            {
                addressHyperLink = new HtmlHyperlink(localbw);
                addressHyperLink.SearchProperties[HtmlHyperlink.PropertyNames.TagName] = "A";
                addressHyperLink.SearchProperties[HtmlHyperlink.PropertyNames.Class] = "searchGridCol";
                return addressHyperLink;
            }
        }
    }
}
